...
public class LotteryTicketModel extends Model {
	 ...
	 * 
	 * 
	 * @param numOfCorrectNumbers
	 *            How many lottery numbers got guessed correctly
	 * @param numOfDrawnNumbers
	 *            How many lottery numbers get drawn in a game
	 * @param totalNumbers
	 *            Total pool of which lottery numbers get drawn from
	...
	public BigDecimal getChance(int numOfCorrectNumbers, int numOfDrawnNumbers, int totalNumbers) {
		...
		BigInteger possibilities = binomi(numOfDrawnNumbers, numOfCorrectNumbers)
				.multiply(binomi(totalWrongNumbers, numOfWrongGuesses));
		BigInteger numOfTotalPossibilities = binomi(totalNumbers, numOfDrawnNumbers);

		// Cast to Big Decimal in order to calculate chance. BigInt would be rounded
		// down to zero
	...
	/**
	 * Calculates the combined chance (normal and lucky numbers) for a lottery
	 * ticket
	 * 
	 * @param pickedCorrectNormal
	 *            How many lottery numbers got guessed correctly
	 * @param pickedCorrectLuckys
	 *            How many lottery lucky numbers got guessed correctly
