...
import lotto.splashScreen.Splash_Controller;
import lotto.splashScreen.Splash_Model;
import lotto.splashScreen.Splash_View;
...
public class LotteryTicketMain extends Application {
    ...
    private LotteryTicketView view;
    ...
    protected static LotteryTicketMain getMainProgram() {
        return mainProgram;
    }
}
