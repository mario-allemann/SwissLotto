...
import estimatingPI.piMainView.PiController;
import estimatingPI.piMainView.PiModel;
import estimatingPI.piMainView.PiView;
import estimatingPI.splashScreen.Splash_Controller;
import estimatingPI.splashScreen.Splash_Model;
import estimatingPI.splashScreen.Splash_View;
...
public class PiMain extends Application {
    ...
    public void startApp() {
        ...
        view = new PiView(appStage, model);
        new PiController(model, view);
    ...
    protected static PiMain getMainProgram() {
        return mainProgram;
    }
}
